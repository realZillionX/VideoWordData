...
def main(base_dir=None, num_samples=None, start_idx=0, num_workers=None):
    ...
    TASK_JSONL_PATH = DATASET_DIR / f"belle_school_math_inference_video_data_{start_idx}.jsonl"
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Generate BELLE School Math video dataset (Inference)")
